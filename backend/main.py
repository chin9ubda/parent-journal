...
from routes import auth_routes, user_routes, entry_routes, test_routes, export_routes, growth_routes, care_routes, babyfood_routes, hospital_routes, vaccination_routes, children_routes
